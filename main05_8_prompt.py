...
def generate_answer(video_path, question, candidates, max_frames=8):
...
output_file = os.path.join(output_folder, "output_05b_8_prompt.txt")
...
plt.savefig(os.path.join(output_folder, 'option_freq05_8_prompt.jpg'))
plt.show()
